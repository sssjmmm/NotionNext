...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '2558998786b0440191480367107e19cc',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'S+M', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '同济大学软件学院大三在读', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.sujiaming.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, sjm', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/ming.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-GRJQ92EN8G', // 谷歌Analytics的id e.g: G-XXXXXXXXXX

  // 51la 站点统计 https://www.51.la/
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3HIPn8eXx1oJ0GZh', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3HIPn8eXx1oJ0GZh', // ck，在51la后台获取
